...
#include <ros/ros.h>
#include <subjugator_msgs/Thrust.h>
#include <subjugator_msgs/ThrusterCmd.h>

#include <algorithm>
#include <cmath>
#include <map>
#include <mutex>
#include <subjugator_gazebo/subjugator_thruster_config.hpp>
#include <vector>
...
struct Thruster
{
  ...
  Thruster(subjugator_gazebo::ThrusterDef td)
  {
...
public:
  ...
  virtual void Init();
  void ThrustCallback(const subjugator_msgs::Thrust::ConstPtr &thrust);
...
protected:
  ...
  ros::Time lastTime;
  std::vector<subjugator_msgs::ThrusterCmd> cmdQueue;
};
}  // namespace gazebo
