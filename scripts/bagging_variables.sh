...
export bag_status="/c3_trajectory_generator/waypoint /trajectory /wrench/cmd /wrench/selected /battery_monitor /adaptation /diagnostics /learn /alarm /alarm_raise"
