...
{
  return quat_from_rotvec(w_E * t) * ecef_vel + w_E.cross(eci_pos);
}
...
{
  return quat_from_rotvec(w_E * t) * ecef_acc + w_E.cross(w_E.cross(eci_pos));
}
...
{
  return quat_from_rotvec(-w_E * t) * (eci_vel - w_E.cross(eci_pos));
}
...
{
  return quat_from_rotvec(-w_E * t) * (eci_acc - w_E.cross(w_E.cross(eci_pos)));
}
