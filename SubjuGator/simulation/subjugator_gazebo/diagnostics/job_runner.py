...
from subjugator_gazebo_tools import BagManager
from twisted.internet import reactor

rospack = rospkg.RosPack()
DIAG_OUT_DIR = os.path.join(rospack.get_path("subjugator_gazebo"), "diagnostics/")
...
if __name__ == "__main__":
    usage_msg = (
        ...
        + "\n\n\trosrun subjugator_gazebo job_runner align_marker_test"
    )
