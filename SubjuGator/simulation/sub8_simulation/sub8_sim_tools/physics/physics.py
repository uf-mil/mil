...
class World:
    def __init__(self, dt: float = (1 / 45.0)):
        """This section incorporates PyODE to define methods to create and draw
        three objects: a sphere, box, or cylinder.
    ...
    def add_entity(self, Entity_Type: T, *args, **kwargs) -> T:
        """
...
class Entity(object):
    ...
    def submerged_volume(self):
        ...
        sphere_volume = (4.0 / 3.0) * (np.pi * (self.radius**3.0))
    ...
    def apply_damping_torque(self):
        ...
        norm_velocity = self._rotational_damping_coeff * np.linalg.norm(
            angular_velocity
        )
