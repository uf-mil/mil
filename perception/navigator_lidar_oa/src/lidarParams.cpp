...
const double MAX_ROLL_PITCH_ANGLE_DEG = 2.5;
...
const double MIN_OBJECT_SEPERATION_DISTANCE = 3.0;
...
const double MIN_GATE_SEPERATION = 22;
const double MAX_GATE_SEPERATION = 40;
const double MAX_GATE_ERROR_METRIC = 15;
const int MIN_HITS_FOR_VOLUME = 31;
const int OBJECT_INFLATION_PARAMETER = 2;