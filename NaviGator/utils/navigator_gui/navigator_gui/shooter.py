...
class Shooter(Plugin):
    ...
    def cache_disc_speed_setting(self, speed: int) -> None:
        """
    ...
    def update_shooter_status(self) -> None:
        """
