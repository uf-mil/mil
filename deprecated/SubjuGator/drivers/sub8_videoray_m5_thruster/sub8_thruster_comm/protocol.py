...
class Const(object):
    ...
    # Standard propulsion response is the device type (1 byte) followed by 4
    # 32-bit floats and 1 byte
    ...
    # Address, size, type (format char), and read/write status of named CSR
    # fields
    csr_address = {
