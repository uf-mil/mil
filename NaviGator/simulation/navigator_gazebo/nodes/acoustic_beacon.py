...
class AcousticBeaconLocator:
    ...
    def odometrySubscriber(self, msg: Odometry):
        self.pos = msg.pose.pose.position
        self.orientation = msg.pose.pose.orientation
        self.odomSet = True

    def rangeSubscriber(self, msg: RangeBearing):
    ...
    def handler(self, _: AcousticBeaconRequest) -> AcousticBeaconResponse:
        # [x, y, z]
        ...
        theta = yaw - (
            -self.bearing
        )  # temporary line until VRX fixes Range,Bearing standard
