...
def inertial_vel_from_ecef_vel(t, tup, inertial_point):
    x, y, z = tup
    th = w_E * t  # needs offset
    th = w_E * t  # needs offset
    return numpy.array(
...
def ecef_vel_from_inertial_vel(t, tup, inertial_point):
    x, y, z = tup
    th = w_E * t  # needs offset
