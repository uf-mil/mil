...
class Nodelet : public nodelet::Nodelet {
 ...
 public:
  ...
  virtual void onInit() {
    ...
    sub_fieldinfo = nh.subscribe<FieldInfo>("/imu/mag_generated_info", 1000,
                                            boost::bind(&Nodelet::handle_fieldinfo, this, _1));
...
PLUGINLIB_DECLARE_CLASS(magnetic_dynamic_compensation, nodelet,
                        magnetic_dynamic_compensation::Nodelet, nodelet::Nodelet);
}
