...
SubjuGatorStartGateDetector::SubjuGatorStartGateDetector() : nh("~"), timeout_for_found_(2), tf_listener_(tf_buffer_)
{
  ...
  vision_request_service_ =
      nh.advertiseService("/vision/start_gate/pose", &SubjuGatorStartGateDetector::vision_request_cb, this);
  active_service_ =
      nh.advertiseService("/vision/start_gate/enable", &SubjuGatorStartGateDetector::set_active_enable_cb, this);

  run();
}

std::vector<cv::Point> SubjuGatorStartGateDetector::get_2d_feature_points(cv::Mat image)
{
  // Filter the image
...
void SubjuGatorStartGateDetector::run()
{
...
void SubjuGatorStartGateDetector::determine_start_gate_position()
{
...
bool SubjuGatorStartGateDetector::set_active_enable_cb(std_srvs::SetBool::Request &req,
...
bool SubjuGatorStartGateDetector::vision_request_cb(subjugator_msgs::VisionRequest::Request &req,
...
std::vector<cv::Point> SubjuGatorStartGateDetector::get_corner_center_points(const std::vector<cv::Point> &features)
{
...
cv::Mat SubjuGatorStartGateDetector::process_image(cv::Mat &image)
{
...
double SubjuGatorStartGateDetector::get_angle(cv::Point a, cv::Point b, cv::Point c)
{
  auto ba = a - b;
  auto bc = c - b;
...
bool SubjuGatorStartGateDetector::valid_contour(std::vector<cv::Point> &contour)
{
...
std::vector<cv::Point> SubjuGatorStartGateDetector::contour_to_2d_features(std::vector<std::vector<cv::Point>> &contour)
{
...
void SubjuGatorStartGateDetector::visualize_k_gate_normal()
{
...
void SubjuGatorStartGateDetector::visualize_3d_points_rviz(const std::vector<Eigen::Vector3d> &feature_pts_3d)
{
