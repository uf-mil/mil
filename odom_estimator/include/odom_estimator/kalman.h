...
GaussianDistribution<InType>
kalman_update(IDistributionFunction<InType, ErrorType> const &df,
  ...
  SqMat<InType::RowsAtCompileTime> new_cov =
    input.cov - K*res.cov*K.transpose();
