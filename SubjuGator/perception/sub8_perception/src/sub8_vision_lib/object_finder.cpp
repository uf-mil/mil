...
Sub8ObjectFinder::Sub8ObjectFinder() try : image_transport(nh), rviz("/torpedo_board/visualization/detection")
{
  ...
  left_image_sub = image_transport.subscribeCamera(left, 1000, &Sub8ObjectFinder::left_image_callback, this);
  right_image_sub = image_transport.subscribeCamera(right, 1000, &Sub8ObjectFinder::right_image_callback, this);
  log_msg << std::setw(1 * tab_sz) << ""
  ...
  detection_switch = nh.advertiseService(activation, &Sub8ObjectFinder::detection_activation_switch, this);
  log_msg << std::setw(1 * tab_sz) << ""
...
bool Sub8ObjectFinder::detection_activation_switch(sub8_msgs::TBDetectionSwitch::Request &req,
...
void Sub8ObjectFinder::left_image_callback(const sensor_msgs::ImageConstPtr &image_msg_ptr,
...
void Sub8ObjectFinder::right_image_callback(const sensor_msgs::ImageConstPtr &image_msg_ptr,
                                            const sensor_msgs::CameraInfoConstPtr &info_msg_ptr)
{
  right_mtx.lock();
