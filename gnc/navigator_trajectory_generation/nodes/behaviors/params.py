...
velmax_pos_plan = np.array([1.1, 0.4, 0.25])  # (m/s, m/s, rad/s), body-frame forward
velmax_neg_plan = np.array([-0.7, -0.4, -0.25])  # (m/s, m/s, rad/s), body-frame backward
...
velmax_pos = np.array([1.5, 0.5, 0.2])  # (m/s, m/s, rad/s), body-frame forward
velmax_neg = np.array([-0.8, -0.5, -0.2])  # (m/s, m/s, rad/s), body-frame backward
