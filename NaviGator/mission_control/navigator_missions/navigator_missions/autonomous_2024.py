...
class Autonomous2024(NaviGatorMission):
    ...
    async def run(self, args: str):
        ...
        self.send_feedback("[AUTONOMOUS] GOING TO ENTRANCE GATE")
        await self.run_mission(GoToPOI, "entrance_gate", str_arg="entrance_gate")
        self.send_feedback("[AUTONOMOUS] STARTING AUTONOMOUS MISSION")
        ...
        self.send_feedback("[AUTONOMOUS] GOING TO SCAN THE CODE")
