...
export bag_down_cam="/camera/down/camera_info /camera/down/$CAM_SUFFIX"
...
# TODO: update topics once new sonar system is merged
export bag_hydrophones="/hydrophones/samples"
