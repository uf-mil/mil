...
sys.path.append(os.path.abspath('mil_common/drivers/mil_passive_sonar/src'))
sys.path.append(os.path.abspath('mil_common/drivers/mil_passive_sonar/src/mil_passive_sonar'))
...
project = u'mil'
copyright = u'2019-2022, Machine Intelligence Lab'
author = u'Machine Intelligence Lab'
...
latex_documents = [
    (master_doc, 'mil.tex', u'mil Documentation',
     u'Machine Intelligence Lab', 'manual'),
]
...
man_pages = [
    (master_doc, 'mil', u'mil Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'mil', u'mil Documentation',
     author, 'mil', 'One line description of project.',
     'Miscellaneous'),
]
