...
//									Graveyard
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/*void AStar::changeHeuristic()
{
	if (whichSearch == ASTAR)
	{
		whichSearch = DJ;
		cout << "Search method set to DJ!" << endl;
	}
	else if (whichSearch == DJ)
	{
		whichSearch = GREEDY;
		cout << "Search method set to Greedy!" << endl;
	}
	else
	{
		whichSearch = ASTAR;
		cout << "Search method set to Astar!" << endl;
	}
}*/
...
/*
void AStar::flipObstacle(unsigned x, unsigned y)
{			
	if (map[y][x].status != TERRAIN) {
		map[y][x].status = TERRAIN;
		//cout << "Terrain set for " << x << "," << y << endl;
	} else
		map[y][x].status = UNKNOWN;
}

void AStar::setTerrain(unsigned x, unsigned y)
{
	map[y][x].status = TERRAIN;
}
*/