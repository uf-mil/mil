...
#include <string>
#include <subjugator_vision_lib/stereo_base.hpp>
#include <vector>
...
private:
  ...
  bool vision_request_cb(subjugator_msgs::VisionRequest::Request &req, subjugator_msgs::VisionRequest::Response &resp);
