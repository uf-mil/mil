...
class DiceDetect(object):
    ...
    def __init__(self):
        ...
        self.debug_image_input_publisher= rospy.Publisher("dice/debugimageinput", Image,queue_size=1)
        ...
        self.image_subscriber= rospy.Subscriber("/camera/front/left/image_rect_color", Image, self.callback)
        ...
        for key, value in output_dict.iteritems():
            ...
            if (int(key) > 0) :
                ...
                try:
                    ...
                    self.debug_image_input_publisher.publish(self.bridge.cv2_to_imgmsg(input_image, "bgr8"))
