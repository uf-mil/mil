...
class Dashboard(Plugin):
    ...
    @thread_lock(lock)
    def cache_kill_status(self, alarm: Alarm) -> None:
        self.kill_status["current"] = alarm.raised

    @thread_lock(lock)
    def cache_operating_mode(self, msg: String) -> None:
        self.operating_mode["current"] = msg.data

    @thread_lock(lock)
    def cache_battery_voltage(self, msg: Float32) -> None:
        self.battery_voltage["current"] = msg.data

    @thread_lock(lock)
    def cache_hosts(self, msg: Hosts) -> None:
        """
    ...
    def update_operating_mode_status(self) -> None:
        """
    ...
    def monitor_battery_voltage(self) -> None:
        """
    ...
    def update_battery_voltage_status(self) -> None:
        """
    ...
    def update_hosts_status(self) -> None:
        """
