...
alias mcfmt="python2.7 -m flake8 --ignore E731 --max-line-length=120 --exclude=__init__.py,\$CATKIN_DIR/src/mil_common/drivers/pointgrey_camera_driver,\$CATKIN_DIR/src/mil_common/drivers/mil_passive_sonar \$CATKIN_DIR/src/mil_common"
