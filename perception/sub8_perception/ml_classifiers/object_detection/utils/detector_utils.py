...
TRAINED_MODEL_DIR = '/home/pablo/mil_ws/src/SubjuGator/perception/sub8_perception/ml_classifiers/object_detection/frozen_graphs'
# Path to frozen detection graph. This is the actual model+weights that is used for the object detection.
PATH_TO_CKPT = TRAINED_MODEL_DIR + '/faster_rcnn_243_dice_v2/frozen_inference_graph.pb'
