...
class LidarToImage:
    ...
    def _get_2d_points(self, points_3d):
        ...
        points_2d = (self.camera_model.project3dToPixel(x) for x in points_3d)
        return points_2d
    ...
    async def get_object_rois(self, name=None):
        ...
        points_2d_all = (self.camera_model.project3dToPixel(x) for x in points_3d)
    ...
    async def get_3d_points(self, perc_obj):
        ...
        stereo_points = (trans.as_matrix().dot(x) for x in stereo_points)
        points = []
