...
class Wildlife2024(NaviGatorMission):
    ...
    async def explore_closest_until(self, is_done, filter_and_sort) -> dict:
        ...
        while True:
            ...
            labels = (
                [obj[0].labeled_classification for obj in ret]
                if ret is not None
                else []
            )
    ...
    async def find_wildlife(self):
        ...
        for animal in animals:
            ...
            if label == self.animal_to_circle:
                await self.circle_animal(animal)
                if self.animal_to_circle == "red_python_buoy":
                    await self.circle_animal(animal)
    ...
    async def run(self, args):
        ...
        self.animal_to_circle = rospy.get_param("animal_to_circle", "red_python_buoy")
