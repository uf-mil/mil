...
#include <subjugator_msgs/TBDetectionSwitch.h>
#include <subjugator_msgs/TorpBoardPoseRequest.h>
...
#include <stdexcept>
#include <string>
#include <subjugator_vision_lib/visualization.hpp>
#include <utility>
#include <vector>
...
/*
  ...
  For examlple, the following will not compile:
    SubjuGatorTorpedoBoardDetector tb_detector = SubjuGatorTorpedoBoardDetector();
  Do this instead:
    SubjuGatorTorpedoBoardDetector tb_detector();
*/
...
private:
  // Callbacks
  bool detection_activation_switch(subjugator_msgs::TBDetectionSwitch::Request &req,
