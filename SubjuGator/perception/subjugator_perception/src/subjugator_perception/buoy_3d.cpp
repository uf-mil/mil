...
bool SubjuGatorBuoyDetector::request_buoy_position(subjugator_msgs::VisionRequest::Request &req,
                                                   subjugator_msgs::VisionRequest::Response &resp)
{
  ...
  detection_success = determine_buoy_position(cam_model, target_name, target_image, target_cloud, position);
...
bool SubjuGatorBuoyDetector::determine_buoy_position(const image_geometry::PinholeCameraModel &camera_model,
                                                     const std::string &target_color, const cv::Mat &image_raw,
                                                     const sub::PointCloudT::Ptr &point_cloud_raw,
                                                     Eigen::Vector3f &center)
{
  subjugator_msgs::VisionRequest2D::Request req;
